...
// Usage:
//   node scripts/search_translation_in_db.js
//
// It searches:
// - factory.Translations
// - <project>.Translations for all project DBs
// - factory.Tasks (in label, examples, data.nlpProfile.examples, data.examples)
...
async function main() {
  ...
  const searchText = 'Mi dica la numero del ticket';
