        ...
        For Each eng As NLPEngine In ideContract.Engines
            ...
            Select Case typeName
                Case "grammarflow"
                    ...
                    engines.Add(New CompiledGrammarFlowUtteranceEngine(dn, task, compiledContract, table, eng.GrammarFlow))
                Case "regex"
                    Dim dn = $"Regex #{ordinal} ({If(compiledContract.TemplateName, "contract")})"
                    engines.Add(New CompiledRegexUtteranceEngine(dn, task, compiledContract, table))
                Case Else
