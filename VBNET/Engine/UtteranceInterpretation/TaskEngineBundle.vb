...
Namespace UtteranceInterpretation
    ...
    Public NotInheritable Class TaskEngineBundle
        ...
        Private ReadOnly _engines As IReadOnlyList(Of IUtteranceInterpretationEngine)
        ...
        Public ReadOnly Property Engines As IReadOnlyList(Of IUtteranceInterpretationEngine)
            Get
                Return _engines
            End Get
        End Property
        ...
        Public Sub New(taskId As String, engines As IReadOnlyList(Of IUtteranceInterpretationEngine), utteranceTask As CompiledUtteranceTask)
            If String.IsNullOrWhiteSpace(taskId) Then Throw New ArgumentNullException(NameOf(taskId))
            _taskId = taskId
            _engines = If(engines, New List(Of IUtteranceInterpretationEngine)())
