...
Namespace GrammarInterpreter.Interpreter
    ...
    Public Class GrammarInterpreter
        ...
        ''' <summary>
        ''' Creates a new interpreter from a compiled grammar
        ''' </summary>
        ...
        ''' <summary>
        ''' Creates a new interpreter from a raw grammar (compiles it first)
        ''' </summary>
        ...
        ''' </summary>
        Public ReadOnly Property CompiledGrammar As CompiledGrammar
            Get
