...
- `TaskEngine` (DDTEngine - progetto libreria)
- `Compiler` (progetto libreria)
- `Orchestrator` (progetto libreria)
- `ApiServer` (progetto applicazione)
