...
- **Accordion espanso** per ogni backend:
  ...
  - **Regola standard webhook ConvAI:** su campi opzionali la stringa vuota \`""\` = campo assente (ElevenLabs invia spesso strutture piene di vuoti). Documentata in OpenAPI al «Recupera specifiche», nel report readiness e normalizzata dal gateway Omnia.
