...
export function buildReviewAgentDockValue(
  ...
  return {
    ...
    compileUseCasePhrasesForCatalog: async () => false,
    rebuildSlotMappingFromScratch: async () => false,
    ...
    upsertDesignerSlotRegistry: reviewNoop,
    assignDesignerSurfaceSlotMapping: reviewNoop,
    updateSurfaceSendHint: reviewNoop,
