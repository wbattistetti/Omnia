...
export function FlowBotTurnLabel(props: {
  ...
  return (
    <div className="flex w-full max-w-xs lg:max-w-md xl:max-w-xl flex-col gap-0">
      <div
        className={`group flex items-start gap-2 rounded-lg border px-3 py-2 text-sm transition-colors ${bubbleTone}`}
      >
