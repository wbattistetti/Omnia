/**
 * Toast sulla Descrizione: propone polish IA; durante la chiamata resta visibile con spinner.
 */

import React from 'react';
import { Loader2, Sparkles, X } from 'lucide-react';
import {
  LABEL_POLISH_DESIGN_DESCRIPTION_OFFER,
  LABEL_POLISH_DESIGN_DESCRIPTION_PENDING,
} from './constants';

export interface DesignDescriptionPolishOfferProps {
  visible: boolean;
  busy: boolean;
  onAccept: () => void;
  onDismiss: () => void;
...
export function DesignDescriptionPolishOffer({
  visible,
  busy,
  onAccept,
  onDismiss,
}: DesignDescriptionPolishOfferProps): React.ReactElement | null {
  ...
  return (
    ...
    >
      ...
      <p className="pr-5 text-[11px] leading-snug text-amber-50/95">
        {LABEL_POLISH_DESIGN_DESCRIPTION_OFFER}
      </p>
      <button
        type="button"
