...
export function AIAgentUnifiedPromptField({
  ...
  const placeholder =
    mode === 'description'
      ? "Es.: Prenota visita medica: tipo visita, date disponibili, nome e cognome, telefono, conferma. L'utente può correggere in qualsiasi momento."
      : "Prompt inviato all'LLM a runtime.";

  return (
    <section>
      <div className="flex flex-wrap items-start justify-between gap-2 mb-1">
        <label className="block text-sm font-medium text-slate-300 min-w-0 flex-1">{label}</label>
