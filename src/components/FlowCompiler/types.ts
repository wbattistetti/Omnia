...
/** Scroll target inside Task Editor → Agent setup (IA Runtime) after opening the AI Agent editor. */
export type IaRuntimeFocus =
  | 'voice'
  | 'language'
  | 'llm'
  | 'agentId'
 ...
 * VB compiler emits structural targets; client-side IA validation may emit `iaRuntime`.
 */
export type FixTarget =
  ...
  | { type: 'iaRuntime'; taskId: string; focus: IaRuntimeFocus };
