...
export const CustomEdge: React.FC<CustomEdgeProps> = (props) => {
  ...
  }, [edgePath, props.data?.label, props.label, captionSize.width, captionSize.height]);
  ...
  return (
    ...
    >
      ...
      {(props.data?.label || props.label) && (
        <g>
          <foreignObject
            x={midPoint.x - captionSize.width / 2}
            y={midPoint.y - captionSize.height / 2}
            width={captionSize.width || 10}
            height={captionSize.height || 10}
