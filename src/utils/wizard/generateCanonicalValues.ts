 ...
 * Canonical values should be derived deterministically from the node structure, not generated by AI.
 *
...
export async function generateCanonicalValuesForNode(
  ...
  const errorMessage = `generateCanonicalValuesForNode is FORBIDDEN. SemanticContract must be deterministic and never modified by AI. ` +
    `The contract defines WHAT data to extract and HOW to return it. ` +
    `Canonical values should be derived deterministically from the node structure, not generated by AI.`;
  console.error('[generateCanonicalValuesForNode] ❌ FORBIDDEN:', errorMessage);
