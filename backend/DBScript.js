...
// Script per aggiungere prompt template stile call center ai template DDT e creare le translations
...
// Funzione per generare prompt template basati sul tipo di dato
  ...
  try {
    ...
    for (const template of templates) {
      ...
      try {
        ...
        // Genera stepPrompts e translations
